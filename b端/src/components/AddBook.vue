  ...
  <div class="container ml-3">
    <form class="row" id="addForm">
      <div class="form-group col-lg-5">
        ...
        <input @keyup.enter="focusChange(this)" v-model="addPublilsh" type="text" class="form-control"> 价格：
        <input @keyup.enter="focusChange(this)" v-model="addPrice" type="text" class="form-control"> 库存：
        <input @keyup.enter="focusChange(this)" v-model="addStorage" type="text" class="form-control">类别：
        <input @keyup.enter="focusChange(this)" v-model="addGenere" type="text" class="form-control">
      </div>
      <div class="form-group col-lg-7 pl-5">
        <div class="row">
          <div class="col-lg-8">
            ...
            <div class="custom-file">
              <input @change="getCover($event)" type="file" accept="image/png,image/gif,image/jpg,image/jpeg"
        ...
        <div class="row">
          <div class="col-lg-6">
            <input class="btn btn-primary btn-block btn-sm mt-2" type="button" value="取消">
          </div>
          <div class="col-lg-6">
...
<script>
  import { fetchAddBook } from '../api.js'
  export default {
    name: "AddBook",
    data() {
      return {
    ...
    methods: {
      ...
      async addBook() {
        ...
        // });
        fetchAddBook(this.addAuthor, this.addISBN, this.addPrice, this.addPublilsh, this.addName, this.addStorage, this.addGenere)
      },
      getCover(event) {
