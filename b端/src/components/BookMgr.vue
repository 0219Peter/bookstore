        ...
        <div class="col-lg-9">
          <div class="row">
            <div class="col-lg-6 col-sm-6">
              <label class="book-name">{{ b.title }}</label>
            </div>
          ...
          <div class="row mt-1">
            ...
            <div class="col-lg-3 col-sm-5">
              <label>库存：</label>
              <label>{{ b.available_quantity }}</label>
            </div>
            <div class="col-lg-6 col-sm-12">
              <label>{{ b.publisher }}</label>
            </div>
          </div>
          <div class="row">
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <input type="text" class="form-control" v-model="isbn"> 编号:
                    <input type="text" class="form-control" v-model="publish"> >书籍分类：
                    <input type="text" class="form-control" v-model="genre"> 价格：
                    <input type="text" class="form-control" v-model="price"> 库存：
                    <input type="text" class="form-control" v-model="available_quantity"> </textarea>
                  </div>
                  <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">取消</button>
                    <button @click="saveBook(book.bookid,index)" type="button" class="btn btn-primary"
...
<script>
  import { fetchBookMgrSearch, fetchBookMgrModify } from '../api.js'
  export default {
    name: "BookMgr",
    data() {
      return {
    ...
    methods: {
      ...
      async searchBook() {
        const data = await fetchBookMgrSearch(this.keyWords)
      ...
      saveBook(id, index) {
        ...
        //   console.log("save ok");
        // });
        fetchBookMgrModify(this.isbn, this.publish, this.author,
          this.title,
