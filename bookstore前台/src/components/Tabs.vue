    ...
    data(){
        return{
            ...
            bookinfox:[
                    ...
                    {name: '操作系统', author: '老子', price: 10.1},
                    { name: '计算机组成结构', author: '孔子',price: 10.2},
                    { name: '编译原理', author: '老子一', price: 10.1 },
                    { name: '计算机网络', author: '孔子一', price: 10.2 },
                    { name: '数据结构', author: '老子二', price: 10.1 },
